...
function DrawerOverlay({
  ...
  return (
    <DrawerPrimitive.Overlay
      ...
      // A flat `--scrim`, never a frost (dialog.tsx says why). vaul animates
      // this itself; globals.css holds its numbers to `motion-overlay`'s.
      className={cn(
  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      >
        ...
        <div className="mx-auto mt-4 hidden h-1 w-24 shrink-0 rounded-full bg-muted group-data-[vaul-drawer-direction=bottom]/drawer-content:block group-data-[drag=off]/drawer-content:hidden!" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  )
